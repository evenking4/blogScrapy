...
class CrowdstrikeSpider(scrapy.Spider):
    website_name = "crowdstrike"
    name = "crowdstrike_link"
    allowed_domains = ["www.crowdstrike.com"]
    start_urls = ["https://www.crowdstrike.com/en-us/blog/category.cloud-security/",
    ...
    # 自制日志记录器
    myLog = logging.getLogger("Crowdstrike")

    def __init__(self, *args, **kwargs):
        super(CrowdstrikeSpider, self).__init__(*args, **kwargs)
    ...
    #
    #     # page_num xpath路径
    #     page_num = int(response.xpath('//ul[@id="page-numbers-ul"]/li[last()-1]/text()').get())
    #
