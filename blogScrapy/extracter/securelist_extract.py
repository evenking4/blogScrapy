...
if __name__ == '__main__':
    ...
    for uuid in all_uuids:
        ...
        title = dom.xpath('//h1[@class="c-article__title" or @class="c-title"]/text()')
        ...
        tags = dom.xpath('//div[@class="c-article__categories"]/ul[@class="c-list-tags"]/li/a[@class="c-link-tag"]/span/text()')
        # print('tags:', tags)

        date = dom.xpath('//p[@class="u-uppercase"]/time/@datetime')
