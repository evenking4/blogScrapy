...
class RsaSpider(scrapy.Spider):
    website_name = "rsa"
    name = "rsa_link"
    allowed_domains = ["www.rsa.com"]
    start_urls = ["https://www.rsa.com/resources/blog/"]

    # 用于和页数拼接
    page_base_url = "https://www.rsa.com/resources/blog/page/"
    ...
    def __init__(self, *args, **kwargs):
        super(RsaSpider, self).__init__(*args, **kwargs)
