...
domain = "https://www.kaspersky.com"
...
if __name__ == '__main__':
    ...
    for uuid in all_uuids:
        ...
        title = dom.xpath('//h1[@class="c-article__title"]/text()')
        ...
        tags = dom.xpath('//ul[@class="c-taxonomy c-taxonomy--tags"]/li/a/text()')
        # print('tags:', tags)

        date = dom.xpath('//li[@class="c-article__time c-article__meta-spacer"]/p/time/@datetime')
        date = date[0] if date else ''
        # print('date:', date)

        main_soup = soup.find(name="div",
                              class_="c-article__content")
