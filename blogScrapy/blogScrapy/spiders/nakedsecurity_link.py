...
class Nakedsecurityspider(scrapy.Spider):
    website_name = "nakedsecurity"
    name = "nakedsecurity_link"
    allowed_domains = ["news.sophos.com"]
    start_urls = ["https://news.sophos.com/en-us/category/serious-security/",
    ...
    # 自制日志记录器
    myLog = logging.getLogger("Nakedsecurity")

    def __init__(self, *args, **kwargs):
        super(Nakedsecurityspider, self).__init__(*args, **kwargs)
