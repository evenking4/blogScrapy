...
class KasperskydailySpider(scrapy.Spider):
    website_name = "kasperskydaily"
    name = "kasperskydaily_link"
    allowed_domains = ["www.kaspersky.com"]
    start_urls = ["https://www.kaspersky.com/blog/category/threats/"]
    ...
    # 自制日志记录器
    myLog = logging.getLogger("Kasperskydaily")

    def __init__(self, *args, **kwargs):
        super(KasperskydailySpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        for url in self.start_urls:
            yield Request(url=url,
                          ...
                          dont_filter=True,
                          cb_kwargs={'page_base_url': url + 'page/'},
    ...
    def get_page_num(self, response, **kwargs):
        ...
        # page_num xpath路径
        page_num = int(response.xpath('//ul[@class="c-pagination"]/li[last()-1]/a/text()').get())
        ...
        links.extend(response.xpath(
            '//h3[@class="c-card__title"]/a/@href').getall())
