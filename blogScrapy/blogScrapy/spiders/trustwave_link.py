...
class TrustwaveSpider(scrapy.Spider):
    website_name = "trustwave"
    name = "trustwave_link"
    allowed_domains = ["www.trustwave.com"]
    start_urls = ["https://www.trustwave.com/en-us/resources/blogs/trustwave-blog"]

    # 用于和页数拼接
    page_base_url = "https://www.trustwave.com/en-us/resources/blogs/trustwave-blog/page/"
    ...
    # 自制日志记录器
    myLog = logging.getLogger("Trustwave")

    def __init__(self, *args, **kwargs):
        super(TrustwaveSpider, self).__init__(*args, **kwargs)
