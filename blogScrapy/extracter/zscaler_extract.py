...
if __name__ == '__main__':
    ...
    for uuid in all_uuids:
        ...
        title = dom.xpath('//h1[contains(@class, font-bold)]/text()')
        ...
        date = dom.xpath('//div[contains(@class, "font-normal") and contains(@class, "text-white")]/text()')
        date = date[0] if date else ''
        # print('date:', date)

        main_soup = soup.find(name="div",
                              class_=["wysiwyg_module_content__XGnZp"])
