...
if __name__ == '__main__':
    ...
    for uuid in all_uuids:
        ...
        date = dom.xpath('//div[@class="article-date"]/p[@class="card-text"]/small[@class="text-muted"]/text()')
        ...
        main_soup = soup.find(name="div",
                              class_=["the_content",
                                      "main-content",
                                      "cmp-text pt-4 cmp__richtext--color cmp__richtext--color-default"])
