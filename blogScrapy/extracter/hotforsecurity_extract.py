...
domain = "https://www.bitdefender.com"
...
if __name__ == '__main__':
    ...
    for uuid in all_uuids:
        ...
        tags = dom.xpath('div[@class="tw-mb-2.5 tw-flex tw-flex-wrap tw-items-center tw-text-xs tw-font-bold tw-uppercase tw-text-[#608DFF]"]/a/text()')
        # print('tags:', tags)

        date = dom.xpath('//p[@class="tw-text-[#41485e]"]/text()')
        date = date[0] if date else ''
        # print('date:', date)

        main_soup = soup.find(name="div",
                              class_=["content tw-mb-12 tw-text-lg tw-text-black"])
