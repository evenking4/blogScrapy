...
domain = "https://www.csoonline.com"
...
if __name__ == '__main__':
    ...
    for uuid in all_uuids:
        ...
        # tags = dom.xpath('//div[@class="card__tags"]/span[@class="card__tag"]//text()')
        # print('tags:', tags)

        date = dom.xpath('//div[@class="article-hero"]//div[@class="card__info card__info--light"]/span[1]/text()')
