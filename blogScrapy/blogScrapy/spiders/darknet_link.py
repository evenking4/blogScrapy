...
class DarknetLinkSpider(scrapy.Spider):
    website_name = "darknet"
    name = "darknet_link"
    allowed_domains = ["www.darknet.org.uk"]
    start_urls = ["https://www.darknet.org.uk/"]

    # 用于和页数拼接
    page_base_url = "https://www.darknet.org.uk/page/"
    ...
    # 自制日志记录器
    myLog = logging.getLogger("Darknet")

    def __init__(self, *args, **kwargs):
        super(DarknetLinkSpider, self).__init__(*args, **kwargs)
    ...
    def get_page_num(self, response):
        ...
        # page_num xpath路径
        page_num = int(response.xpath('//div[@role="navigation"]/ul/li[last()-1]/a/text()').get())
