...
if __name__ == '__main__':
    ...
    for uuid in all_uuids:
        ...
        title = dom.xpath('//h1[@class="text-style-h1 mb-8" or contains(@class, "entry-title")]/text()')
        ...
        tags = dom.xpath('//div[@class="mt-6 space-y-2 space-x-1"]/a/text()')
        # print('tags:', tags)

        date = dom.xpath('//span[@class="posted-on"]/a/text()')
